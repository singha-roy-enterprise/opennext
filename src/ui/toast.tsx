                ...
                {toasts.map((t) => {
                    ...
                    return (
                        <div
                            key={t.id}
                            className={cn(
                                "bg-card text-ink flex min-w-[210px] animate-[toastIn_0.25s_ease] items-center gap-2.5 rounded-[3px] border px-4 py-3 text-[13px] font-medium shadow-[0_14px_34px_-16px_rgb(var(--shadow-rgb)/0.5)]",
                                k.border,
                            )}
                        >
