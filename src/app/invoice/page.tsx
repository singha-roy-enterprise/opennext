...
import { generatePDF, validateBillData, hasErrors, type DocumentType, type FieldErrors } from "@/lib/pdf-generator";
            ...
            <main className="mx-auto max-w-[1080px] px-7 pt-[34px] pb-[90px]">
                <div className="border-ink/[0.18] bg-card overflow-hidden rounded-[5px] border shadow-[0_1px_0_rgba(27,25,22,0.04),0_26px_60px_-38px_rgba(27,25,22,0.5)]">
                    ...
                    <div className="border-ink/[0.14] border-b px-[38px] py-[22px]">
                        ...
                        {showReverse && (
                            <div className="border-ink/[0.16] mt-3.5 rounded-[3px] border bg-white p-[18px]">
