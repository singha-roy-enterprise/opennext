        ...
        <div className="bg-paper min-h-screen">
                ...
                <div className="mb-[18px] flex flex-wrap items-center gap-2.5">
                    <div className="relative min-w-[220px] flex-[1_1_260px]">
                        ...
                        <input
                            ...
                            className="border-ink/[0.18] text-ink w-full rounded-[3px] border bg-white py-[11px] pr-[38px] pl-10 text-[13.5px] outline-none"
                        />
                        ...
                        {suggestions.length > 0 && (
                            <div className="border-ink/20 absolute top-[calc(100%+5px)] right-0 left-0 z-30 rounded-[3px] border bg-white p-[5px] shadow-[0_18px_40px_-20px_rgba(27,25,22,0.5)]">
                                {suggestions.map((sug) => (
                                    <button
                                        key={sug.id}
                                        type="button"
                    ...
                    <div className="border-ink/[0.18] inline-flex items-center overflow-hidden rounded-[3px] border bg-white">
                    ...
                    <div className="flex items-center gap-2">
                        <div className="relative flex items-center">
                            <select
                                ...
                                className="border-ink/[0.18] text-ink cursor-pointer appearance-none rounded-[3px] border bg-white py-2.5 pr-[30px] pl-3 text-[13px] font-medium outline-none"
                            >
                        ...
                        <button
                            ...
                            className="border-ink/[0.18] text-accent flex size-[38px] cursor-pointer items-center justify-center rounded-[3px] border bg-white"
                        >
                            <ArrowDownIcon
                                size={16}
                    ...
                    <button
                        type="button"
                        onClick={exportCsv}
                        className="border-ink/[0.22] text-ink hover:border-ink inline-flex cursor-pointer items-center gap-2 rounded-[3px] border bg-white px-3.5 py-2.5 text-[13px] font-semibold transition-colors"
                    >
            ...
            {confirm && (
                <div
                    ...
                    className="bg-ink/[0.45] fixed inset-0 z-[60] flex animate-[overlayIn_0.18s_ease] items-center justify-center p-6"
                >
                    <div
    ...
    return (
        ...
        >
            ...
            <div className="flex items-center gap-[9px]">
                {isAdmin ? (
                    <>
                        <div className="border-ink/[0.18] inline-flex items-center rounded-[3px] border bg-white">
                            <button
                                type="button"
                                onClick={onDec}
                                title="Stock out"
...
function CardItem({ item, isAdmin, selected, onToggle, onInc, onDec, onEdit, onDelete }: RowActions) {
    ...
    const margin = marginParts(item);
    return (
        <div className={cn("rounded-[3px] border bg-white p-4", selected ? "border-accent" : "border-ink/[0.14]")}>
...
function ItemDrawer({
    ...
    return (
        <div onClick={onClose} className="bg-ink/40 fixed inset-0 z-50 flex animate-[overlayIn_0.2s_ease] justify-end">
            <div
                onClick={(e) => e.stopPropagation()}
